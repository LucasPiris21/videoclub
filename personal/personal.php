...
if (empty($_GET['submit']) or isset($_GET['clear'])) {
	...
	$busq=$_GET['busq'];
	$query="SELECT * FROM `personal` WHERE concat(dni,nombre,telefono,cargo,contrasena) LIKE '%$busq%'";
	$consulta=mysqli_query($conexion,$query);
}
...
<body>
	...
	<div class="container-sm main">
		...
		<div class="row justify-content-center">
			<div class="col-md-auto">
				<img src="../images/personaltitle.png">
			</div>
		</div>
		<br>
			...
			<div class="col-md-10">
										...
										case 'Administrador':
											if ($_SESSION['cargo']=="Administrador") {
												echo "<td class='text-center'>";
													echo '<a href="deletepersonal.php?dni='.$fila[0].'" class="btn btn-danger">Eliminar</a>';
												echo "</td>";
												echo "<td class='text-center'>";
													echo '<a href="updatepersonalform.php?dni='.$fila[0].'" class="btn btn-danger">Modificar</a>';
												echo "</td>";
											} else{
				...
				<div class="row justify-content-star">
						<div class="col-md-auto align-self-center">
							<a href='altapersonalform.php' class="add btn btn-danger">Agregar Personal</a>
						</div>
				</div>
			</div>
		</div>
