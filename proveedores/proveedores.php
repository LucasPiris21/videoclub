...
if (empty($_GET['submit']) or isset($_GET['clear'])) {
	...
	$busq=$_GET['busq'];
	$query="SELECT * FROM `proveedores` WHERE concat(cuit,nombre,telefono,direccion) LIKE '%$busq%'";
	$consulta=mysqli_query($conexion,$query);
}
...
<body>
	...
	<div class="container-sm main">
		...
		<div class="row justify-content-center">
			<div class="col-md-auto">
				<img src="../images/proveedorestitle.png">
			</div>
		</div>
		<br>
		...
		<div class="row justify-content-center">
			<div class="col-md-10">
								...
								echo "<tr>";
									...
									if ($_SESSION['cargo']<>"Empleado") {
										echo "<td class='text-center'>";
											echo '<a href="deleteproveedores.php?id='.$fila[0].'" class="btn btn-danger">Eliminar</a>';
										echo "</td>";
										echo "<td class='text-center'>";
											echo '<a href="updateproveedoresform.php?id='.$fila[0].'" class="btn btn-danger">Modificar</a>';
										echo "</td>";
									} else {
				...
				<?php
				if ($_SESSION['cargo']<>"Empleado") {
					echo '<div class="row justify-content-star">';
						echo '<div class="col-md-auto align-self-center">';
							echo "<a href='altaproveedoresform.php' class='add btn btn-danger'>Agregar Proveedor</a>";
						echo '</div>';
					echo '</div>';
				}
				?>
