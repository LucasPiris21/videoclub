...
if (empty($_GET['submit']) or isset($_GET['clear'])) {
	...
	$busq=$_GET['busq'];
	$query="SELECT * FROM `clientes` WHERE concat(dni,nombre,telefono,email) LIKE '%$busq%'";
	$consulta=mysqli_query($conexion,$query);
}
...
<body>
	...
	<div class="container-sm main">
		...
		<div class="row justify-content-center">
			<div class="col-md-auto">
				<img src="../images/clientestitle.png">
			</div>
		</div>
		<br>
			...
			<div class="col-md-10">
							...
							<?php while ($fila=mysqli_fetch_array($consulta)) {
								echo "<tr>";
									...
									echo "<td class='text-center'>";
										echo '<a href="deletecliente.php?dni='.$fila[0].'" class="btn btn-danger">Eliminar</a>';
									echo "</td>";
									echo "<td class='text-center'>";
										echo '<a href="updateclienteform.php?dni='.$fila[0].'" class="btn btn-danger">Modificar</a>';
									echo "</td>";
								echo "</tr>";
							 }?>
						</tbody>
				...
				<div class="row justify-content-star">
						<div class="col-md-auto align-self-center">
							<a href='altaclienteform.php' class="add btn btn-danger">Agregar Cliente</a>
						</div>
				</div>
			</div>
		</div>
